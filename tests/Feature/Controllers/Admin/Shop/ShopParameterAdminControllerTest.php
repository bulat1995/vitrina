...
class ShopParameterAdminControllerTest extends TestCase
{
    use RefreshDatabase;
    use WithoutMiddleware;
    use UserTrait;
    private $uri='/admin/shop/parameters';

    private $routePath='admin.shop.parameters.';
    ...
    public function testStoreWrong()
    {
        ...
        $response->assertSessionHasErrors('inputType');
